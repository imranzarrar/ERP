...
{ id: '019fa55c-622a-739d-91eb-0c81dc711c7b', key: 'Welcome back, ', en: 'Welcome back, ', ar: 'مرحباً بعودتك، ', ur: 'خوش آمدید، ' },
  ...
  { id: '8c4f2b3d-5e7f-4b2c-ad9e-2f3a4b5c6d0b', key: 'Warraq ERP System', en: 'Warraq ERP System', ar: 'نظام وراق ERP', ur: 'وراق ERP سسٹم' },
  { id: '8c4f2b3d-5e7f-4b2c-ad9e-2f3a4b5c6d0c', key: 'ZATCA Integrated Invoicing Solution', en: 'ZATCA Integrated Invoicing Solution', ar: 'حل فوترة متكامل مع زاتكا', ur: 'زاتکا کے ساتھ مربوط انوائسنگ حل' },
  ...
  { id: '85fe6bbd-8bb2-4371-a877-7c93e9d0f5da', key: 'Are you sure you want to deactivate this recurring template? This will not affect prior postings but prevents future occurrences.', en: 'Are you sure you want to deactivate this recurring template? This will not affect prior postings but prevents future occurrences.', ar: 'هل أنت متأكد أنك تريد إلغاء تفعيل هذا القالب المتكرر؟ لن يؤثر ذلك على الترحيلات السابقة، لكنه سيمنع الترحيلات المستقبلية.', ur: 'کیا آپ واقعی اس بار بار والے ٹیمپلیٹ کو غیر فعال کرنا چاہتے ہیں؟ اس سے پچھلی پوسٹنگز متاثر نہیں ہوں گی، لیکن مستقبل کی پوسٹنگز رک جائیں گی۔' },
  { id: '25541c14-faf9-41b1-8015-b26d684eead0', key: 'Failed to deactivate recurring template.', en: 'Failed to deactivate recurring template.', ar: 'فشل إلغاء تفعيل القالب المتكرر.', ur: 'بار بار والے ٹیمپلیٹ کو غیر فعال کرنے میں ناکامی۔' },
  { id: 'bfb44e5f-1468-42f5-b27c-8e74aa8a19e7', key: 'Recurring template deactivated successfully.', en: 'Recurring template deactivated successfully.', ar: 'تم إلغاء تفعيل القالب المتكرر بنجاح.', ur: 'بار بار والا ٹیمپلیٹ کامیابی سے غیر فعال کر دیا گیا۔' },
  { id: '364fb066-6ed5-459a-ac34-a2d913535847', key: 'An error occurred while deactivating the template.', en: 'An error occurred while deactivating the template.', ar: 'حدث خطأ أثناء إلغاء تفعيل القالب.', ur: 'ٹیمپلیٹ کو غیر فعال کرتے وقت خرابی پیش آگئی۔' },
  { id: '85cec3ac-7dd0-48d2-87e1-beafbd623b80', key: 'Are you sure you want to cancel this accrual entry? The expense will be marked Cancelled and kept on record (excluded from reports), and its posting slot freed so this template/month can be posted again. A Reversal voucher will be posted if it was already paid.', en: 'Are you sure you want to cancel this accrual entry? The expense will be marked Cancelled and kept on record (excluded from reports), and its posting slot freed so this template/month can be posted again. A Reversal voucher will be posted if it was already paid.', ar: 'هل أنت متأكد أنك تريد إلغاء قيد الاستحقاق هذا؟ سيتم وضع علامة "ملغى" على المصروف مع الاحتفاظ به في السجل (وسيُستبعد من التقارير)، وسيتم تحرير فترة الترحيل الخاصة به لإتاحة ترحيله مرة أخرى لهذا القالب/الشهر. سيتم ترحيل سند عكسي إذا كان قد تم سداده بالفعل.', ur: 'کیا آپ واقعی اس اکرول اندراج کو منسوخ کرنا چاہتے ہیں؟ اخراجات کو "منسوخ شدہ" کے طور پر نشان زد کیا جائے گا اور ریکارڈ میں رکھا جائے گا (رپورٹس سے خارج)، اور اس کی پوسٹنگ سلاٹ خالی کر دی جائے گی تاکہ اس ٹیمپلیٹ/مہینے کو دوبارہ پوسٹ کیا جا سکے۔ اگر پہلے ہی ادائیگی ہو چکی ہے تو ایک ریورسل واؤچر پوسٹ کیا جائے گا۔' },
  { id: 'fac87142-bca1-4914-854a-cfa2eab2b679', key: 'Failed to cancel accrual entry.', en: 'Failed to cancel accrual entry.', ar: 'فشل إلغاء قيد الاستحقاق.', ur: 'اکرول اندراج کو منسوخ کرنے میں ناکامی۔' },
  { id: 'd989a8b7-ccd9-4f1c-ad08-08315001c319', key: 'Accrual entry cancelled successfully.', en: 'Accrual entry cancelled successfully.', ar: 'تم إلغاء قيد الاستحقاق بنجاح.', ur: 'اکرول اندراج کامیابی سے منسوخ کر دیا گیا۔' },
  { id: 'e8e697db-ee1a-4b34-92b5-a06ccc764081', key: 'An error occurred while cancelling the accrual.', en: 'An error occurred while cancelling the accrual.', ar: 'حدث خطأ أثناء إلغاء الاستحقاق.', ur: 'اکرول کو منسوخ کرتے وقت خرابی پیش آگئی۔' },
  { id: '764cc008-1fc7-41fa-b369-503129ddea26', key: 'All Companies', en: 'All Companies', ar: 'جميع الشركات', ur: 'تمام کمپنیاں' },
  { id: 'c0051dd2-2838-4c14-863f-bf59240b8216', key: 'Cash Vendor', en: 'Cash Vendor', ar: 'مورد نقدي', ur: 'کیش وینڈر' },
  { id: 'cac7d915-9aa3-4ca6-bb67-f99c91285ead', key: 'Company', en: 'Company', ar: 'الشركة', ur: 'کمپنی' },
  { id: '8868f63b-a5b4-4a1f-a4ce-263111b4b52d', key: 'Filter by User (exact username)', en: 'Filter by User (exact username)', ar: 'تصفية حسب المستخدم (اسم المستخدم بالضبط)', ur: 'صارف کے مطابق فلٹر کریں (عین یوزر نیم)' },
  { id: 'cd3488b4-d00c-4fa8-8fb3-5338dd6022a8', key: 'Load Older Records', en: 'Load Older Records', ar: 'تحميل السجلات الأقدم', ur: 'پرانے ریکارڈز لوڈ کریں' },
  { id: '6d2f6c77-31bc-404d-98c9-3e2f2f778bb0', key: 'Loading...', en: 'Loading...', ar: 'جارٍ التحميل...', ur: 'لوڈ ہو رہا ہے...' },
  { id: '89438e39-c149-4e64-a22f-65ea1aaf7706', key: 'More are available — use Load Older below.', en: 'More are available — use Load Older below.', ar: 'يوجد المزيد — استخدم زر "تحميل الأقدم" أدناه.', ur: 'مزید ریکارڈز دستیاب ہیں — نیچے "پرانے ریکارڈز لوڈ کریں" استعمال کریں۔' },
  { id: '6d018d05-5901-47e2-8672-5e0083cbac97', key: 'Showing the most recent', en: 'Showing the most recent', ar: 'عرض أحدث', ur: 'تازہ ترین' },
  { id: '9feb0359-855c-4895-a3fc-a04777280e8d', key: 'records matching your filters.', en: 'records matching your filters.', ar: 'سجل مطابق لعوامل التصفية الخاصة بك.', ur: 'ریکارڈز آپ کے فلٹرز سے مطابقت رکھتے ہیں۔' },
  { id: 'f9aa40d4-80b4-435d-b3c2-ed00451293bd', key: 'Warehouse:', en: 'Warehouse:', ar: 'المستودع:', ur: 'گودام:' },
  { id: '3113912e-5430-46fe-96f4-a0b3fb87a9e3', key: 'This account will log in with the email address below — there is no separate username to set.', en: 'This account will log in with the email address below — there is no separate username to set.', ar: 'سيقوم هذا الحساب بتسجيل الدخول باستخدام عنوان البريد الإلكتروني أدناه — لا يوجد اسم مستخدم منفصل لتحديده.', ur: 'یہ اکاؤنٹ نیچے دیے گئے ای میل ایڈریس سے لاگ ان کرے گا — کوئی الگ یوزر نیم مقرر کرنے کی ضرورت نہیں۔' },
  { id: 'cffa39ef-eef7-4008-917c-637c29119494', key: 'Leave blank to default to 123456 — either way, forced to change it on first login unless unchecked below', en: 'Leave blank to default to 123456 — either way, forced to change it on first login unless unchecked below', ar: 'اتركه فارغًا لاستخدام الرقم الافتراضي 123456 — في كلتا الحالتين، سيُطلب من المستخدم تغييره عند أول تسجيل دخول ما لم يتم إلغاء التحديد أدناه', ur: 'خالی چھوڑ دیں تو ڈیفالٹ 123456 استعمال ہوگا — بہرصورت، پہلی لاگ ان پر اسے تبدیل کرنا لازمی ہوگا جب تک نیچے سے غیر منتخب نہ کیا جائے' },
  { id: '69563c45-7a84-4592-bac8-000992ebea33', key: 'Require password change on next login', en: 'Require password change on next login', ar: 'طلب تغيير كلمة المرور عند تسجيل الدخول التالي', ur: 'اگلی لاگ ان پر پاس ورڈ تبدیل کرنا لازمی قرار دیں' },
  { id: '7a26ee14-5f51-4205-a1f8-c711cf53e8ca', key: 'Recommended — the account can\'t do anything else until they set their own password.', en: 'Recommended — the account can\'t do anything else until they set their own password.', ar: 'موصى به — لن يتمكن الحساب من فعل أي شيء آخر حتى يقوم بتعيين كلمة المرور الخاصة به.', ur: 'تجویز کردہ — جب تک صارف اپنا پاس ورڈ خود مقرر نہ کرے، اکاؤنٹ کوئی اور کام نہیں کر سکے گا۔' },
